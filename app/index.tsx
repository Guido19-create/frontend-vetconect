...
const SectionTitle = ({
  ...
  <View style={styles.sectionHeader}>
    <Text style={[styles.sectionTitle, light && { color: COLORS.white }]}>
      {title}
    </Text>
    {subtitle && (
      <Text style={[styles.sectionSubtitle, light && { color: "#e2e8f0" }]}>
        {subtitle}
      </Text>
    )}
  </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.navbar}>
        <Text style={styles.logo}>
          Vet<Text style={{ color: COLORS.secondary }}>Conect</Text>
        </Text>
        {isDesktop ? (
          <View style={styles.navLinks}>
            {["Funcionalidades", "Servicios", "Cómo funciona"].map((item) => (
              <Text key={item} style={styles.navLinkItem}>
                {item}
              </Text>
            ))}
      ...
      <ScrollView ref={scrollViewRef} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.hero, isDesktop && styles.heroDesktop]}>
          <View style={isDesktop ? { flex: 1 } : { width: "100%" }}>
            ...
            <Text style={styles.heroTitleText}>
              Tu clínica veterinaria, 100% digital "SIEMPRE LISTA".
            </Text>
            <Text style={styles.heroDescText}>
              ¿Cansado de usar WhatsApp para gestionar citas y olvidar
              conversaciones? VetConect crea un canal de comunicación limpio
              entre veterinarios y clientes...
            </Text>
            ...
            <View style={styles.floatingCardContainer}>
              <Text style={styles.indicatorText}>
                ✓ Sin tarjeta de crédito | ✓ 5 minutos | ✓ Soporte en español
              </Text>
            </View>
          </View>
          ...
          <View style={styles.floatingCardContainer}>
            ...
            <View
              style={[
                styles.floatingCard,
                { marginTop: 15, alignSelf: "flex-end" },
              ]}
            >
        ...
        <View style={styles.sectionPadding}>
          <SectionTitle
            title="¿QUÉ ES VETCONECT?"
            subtitle="El sistema operativo de tu clínica, hecho por y para veterinarios."
          />
          <View style={isDesktop ? styles.row : styles.column}>
            <FeatureCard
              icon="time-outline"
              title="Recupera 8+ horas"
              desc="Automatiza recordatorios y deja que la agenda trabaje por ti."
            />
            <FeatureCard
              icon="document-text-outline"
              title="Historia Clínica Única"
              desc="Todo el pasado médico de la mascota a un solo click."
            />
            <FeatureCard
              icon="calendar-outline"
              title="Reservas 24/7"
              desc="Tus clientes agendan incluso cuando la clínica está cerrada."
            />
          </View>
        </View>
        ...
        <View style={[styles.sectionPadding, { backgroundColor: "#edf2f4" }]}>
          <SectionTitle
            ...
            subtitle="Todo lo que tu clínica necesita, sin instalar nada."
          />
          <View style={styles.grid}>
            {(
              [
                {
                  t: "Crea tu clínica",
                  d: "Configura perfil, equipo y horarios.",
                  i: "business-outline",
                },
                {
                  t: "Gestión de citas",
                  d: "Agenda inteligente y confirmaciones.",
                  i: "notifications-outline",
                },
                {
                  t: "Historial mascotas",
                  d: "Ficha completa y carnet digital.",
                  i: "paw-outline",
                },
                {
                  t: "Chats con clientes ",
                  d: "Mensajes en tiempo real con tu veterinario",
                  i: "chatbubble-ellipses-outline",
                },
        ...
        {/* CÓMO FUNCIONA */}
        <View
          style={[styles.sectionPadding, { backgroundColor: COLORS.primary }]}
        >
            ...
            {[
              {
                n: "1",
                t: "Regístrate gratis",
                d: "Crea tu cuenta en segundos.",
              },
              {
                n: "2",
                t: "Crea tu clínica",
                d: "Personaliza tu perfil y servicios.",
              },
              {
                n: "3",
                t: "Gestiona pacientes",
                d: "Empieza a recibir citas online.",
              },
            ].map((s, idx) => (
        ...
        <View style={styles.sectionPadding}>
          <SectionTitle
            title="GALERÍA"
            subtitle="Veterinarios reales, momentos reales."
          />
            ...
            {[
              {
                n: "Camila Rojas",
                c: "Patitas Felices",
                t: "VetConect cambió la forma en que organizamos las cirugías.",
              },
              {
                n: "Andrés Molina",
                c: "VetCenter",
                t: "La agenda online redujo las llamadas en un 50%.",
              },
              {
                n: "Lucía Fernández",
                c: "Animalia",
                t: "Tener todo el historial en el móvil es increíble.",
              },
            ].map((test, idx) => (
        ...
        >
          <View
            style={
              isDesktop ? { flex: 1, marginRight: 40 } : { marginBottom: 40 }
            }
          >
            <Text style={styles.heroTitleText}>Crea tu clínica gratis</Text>
            <Text style={styles.heroDescText}>
              Completa estos datos y empieza en menos de 5 minutos.
            </Text>
            ...
            <View style={styles.formCard}>
                    ...
                    <Text
                      style={[
                        ...
                        form.horario === horario &&
                          styles.horarioOptionTextSelected,
                      ]}
                    >
                      {horario}
                    </Text>
              ...
              >
                ...
                <Text style={styles.checkboxText}>
                  Mi clínica requiere aprobación del veterinario para agendar
                  citas
                </Text>
              </TouchableOpacity>

              <Text style={styles.ayudaTexto}>
                * Si activas esta opción, los clientes podrán solicitar citas,
                pero un veterinario deberá confirmarlas manualmente.
              </Text>
          ...
          <View style={isDesktop ? styles.row : styles.column}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ color: "#94a3b8", marginTop: 10 }}>
                El futuro de la gestión veterinaria.
              </Text>
            </View>
          </View>
        </View>
